...
$lang['js']['missingPlugin'] = "The pad is missing the ep_iframeinsert plugin. Therefore this function is currently not available.";
$lang['js']['noGetSelection'] = "This function is not available while the pad is used. [getSelection]";
$lang['js']['noSetSelection'] = "This function is not available while the pad is used. [setSelection]";
$lang['js']['noPasteText'] = "This function is not available while the pad is used. [pasteText]";
$lang['js']['noPreview'] = "The preview cannot be used while the pad is in use.";
$lang['js']['titleOpenPad'] = "Open pad and edit the page with Etherpad";
$lang['js']['titleClosePad'] = "Close pad and transfer the text into the page";
$lang['js']['titleSecurity'] = "Manage access permissions for this pad";
$lang['js']['titleSaveableYes'] = "Pad is already writable";
$lang['js']['titleSaveableNo'] = "Enter password to get write access";
